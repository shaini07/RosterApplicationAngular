 ...
 * ========================================================= */
 ...
 (function($) {
	...
	Calendar.prototype = {
		...
		_initializeDatasourceColors: function () {		    
		    for (var i in this.options.dataSource) {		        
				if(this.options.dataSource[i].color == null) {
				    this.options.dataSource[i].color = this._renderShiftColor(this.options.dataSource[i].name);
				}
				else if(this.options.dataSource[i].color !=this._renderShiftColor(this.options.dataSource[i].name)){
				    this.options.dataSource[i].color = this._renderShiftColor(this.options.dataSource[i].name);
				}
			}
		},
		...
		_renderShiftColor: function(employeeShift){
		    switch (employeeShift) {
		        ///'#2C8FC9', '#9CB703', '#F5BB00', '#FF4A32', '#B56CE2', '#45A597'
		        case 'General Shift':
		            renderStyle = '#2C8FC9';
		            break;
		        case '1st Shift':
